...
class Level:
    ...
    def __init__(self, id: Union[int, str]) -> None:
        """Initialise l'instance du niveau.
    ...
    def get_stars_count(self) -> int:
        """Calcule le nombre d'étoiles actuel en fonction du temps et de l'utilisation des indices.
    ...
    def calculate_inventory(self) -> None:
        """Calcule les exigences d'utilisation des portes et l'utilisation actuelle du joueur."""
        self.max_usage = {}
    ...
    def start_chip(self, chip: Optional[Chip] = None) -> None:
        """Réinitialise les états d'E/S (Entrées/Sorties) des portes au sein de la puce spécifiée.
    ...
    def load(self, data: Dict[str, Any]) -> None:
        """Alimente l'état du niveau à partir d'un dictionnaire de configuration.
    ...
    def __str__(self) -> str:
        ...
        Returns :
            L'identifiant du niveau, son nom et son index.
        """
