...
procédurale de textures pour l'architecture pilotée par les données du jeu.
"""
...
class Loader:
    ...
    def load_single_chip(self, raw_data: Dict[str, Any]) -> None:
        """
        Enregistre un objet "chip" et gère ses exigences en matière de dépendances.
    ...
    def load_fonts(self) -> None:
        """Enregistre les polices TTF externes auprès du moteur de rendu."""
        try:
    ...
    def load_tilesets(self) -> None:
        """Découpe les planches de sprites en grilles de textures pour les composants de l'interface."""
    ...
    def render_gate_image(self, gate: Union[CustomGate, Any]) -> Image.Image:
        """
        Génère une image composite pour une porte logique, incluant les tuiles et les étiquettes de texte.

        Args:
            gate: Le composant de porte à restituer.
    ...
    def bake_single_gate(self, gate: Any, id: str) -> bool:
        ...
        for i in range(2**size):
            # Calcul des états d'entrée/sortie par extraction binaire de drapeaux
    ...
    def bake_predefined_gates(self) -> None:
        """Génère les textures pour toutes les portes système intégrées."""
    ...
    def bake_textures(self) -> None:
        """Coordonne le flux complet de génération procédurale de textures."""
    ...
    def load(self) -> None:
        """Exécute le pipeline complet de chargement des ressources et d'initialisation."""
