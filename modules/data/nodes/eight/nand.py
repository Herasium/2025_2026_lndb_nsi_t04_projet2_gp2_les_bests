...
class Nand(Complex):
    """Représente un composant de porte logique NAND 8 bits.

    Attributs :
        name : Le nom d'affichage de la porte.
        gate_type : L'identifiant de la catégorie de porte logique.
        inputs : Décalages de broches (pin offsets) pour les signaux d'entrée.
        outputs : Décalages de broches (pin offsets) pour les signaux de sortie.
