...
"""Fournit l'implémentation de la porte d'entrée (Input) pour la simulation de circuits."""


class Input(Gate):
    """Représente une porte de commutation d'entrée manuelle au sein d'un circuit."""

    def __init__(self, id: Any) -> None:
        """Initialise la porte Input.
