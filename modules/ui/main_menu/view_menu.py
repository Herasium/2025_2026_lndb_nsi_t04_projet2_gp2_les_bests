...
class GameView(arcade.View):
    ...
    def on_mouse_press(
        ...
        """
        Arguments:
            x: Coordonnée horizontale du clic à l'écran.
            y: Coordonnée verticale du clic à l'écran.
    ...
    def on_mouse_release(
        ...
        """
        Arguments:
            x: Coordonnée horizontale du relâchement à l'écran.
            y: Coordonnée verticale du relâchement à l'écran.
