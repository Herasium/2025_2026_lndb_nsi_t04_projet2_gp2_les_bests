"""Fournit la vue SaveFrame pour l'édition et la sauvegarde des données de configuration des puces."""
...
class ChipList(arcade.View):
    ...
    def on_draw(self) -> None:
        """Affiche tous les éléments de texte configurés de l'interface utilisateur."""
        self.clear()
        self.bg.draw()
